...
function PassenegrSearch() {
    ...
    const search = async (e) => {
        ...
        try {
            ...
            console.error(err);
            setSchedule([]);
            setErrmsg(err.response?.data?.message || "No flights");
        }
    };
        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-xl-8 col-lg-9 col-md-11">
                    ...
                    {
                        <div className="mt-5">
                            <h2 className="fw-bold mb-4">Available Flights ({schedule.length})</h2>
                            {
                                    ...
                                    <div key={index}className="card border-0 shadow-sm rounded-4 mb-4">
                                        <div className="card-body p-4">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-md-2 text-center">
                                                    <h5>{s.destination}</h5>
                                                    <small className="text-muted">{new Date(s.arrivalTime).toLocaleTimeString()}
                                                    </small>
                                                </div>

                                                <div className="col-md-3 text-center">
                                                    <h4 className="text-success fw-bold">₹{s.fare}
                                                    </h4>
                                                    <button className="btn btn-success rounded-pill px-4" onClick={()=>navigate(`/passenger/booking/${s.id}`)}>
                                                        Book Now
                                                    </button>
                                                </div>
                                            </div>
...
export default PassenegrSearch;